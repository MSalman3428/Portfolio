...
const NavBar = () => {
  ...
  // Ensure component is mounted to avoid hydration mismatch for the theme toggle
  useEffect(() => {
    setMounted(true);
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-slate-100 dark:bg-slate-900 text-yellow-500 hover:ring-2 hover:ring-yellow-400/50 transition-all active:scale-90"
